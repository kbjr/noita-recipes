...
const { processMaterialsXML } = require('./build');

const json = require('./materials.json');
const result = processMaterialsXML(json);

console.log(result.reactionsByInputTag['[rust]']);
